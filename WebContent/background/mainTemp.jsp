...
<script type="text/javascript">
	function refreshSystem(){
		$.post("${pageContext.request.contextPath}/init",{},
			function(flag){
				var flag=eval('('+flag+')');
				if(flag){
					alert("系统刷新成功！");
	...
	<div class="span3">
		<div class="newsMenu">
			<ul class="nav nav-tabs nav-stacked">
				  ...
				  <li><a href="${pageContext.request.contextPath}/link?action=preSave">&nbsp;&nbsp;友情链接添加</a></li>
				  <li><a href="${pageContext.request.contextPath}/link?action=backList">&nbsp;&nbsp;友情链接维护</a></li>
